...
Promise.all([
  import("./data/assets.mjs"),
  import("./core/asset-loader.mjs"),
])
...
import("./gameplay/projectiles.mjs")
...
import("./gameplay/enemies-runtime.mjs")
